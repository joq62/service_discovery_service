...
add_1()->
    ...
    ?assertMatch(ok,rpc:call(node(),sd_service,fetch_all,[external_services])),
    ?assertMatch(ok,rpc:call(node(),sd_service,fetch_all,[all])),
    ?assertMatch(ok,rpc:call(?VM1,sd_service,fetch_all,[all])),
    ok.
